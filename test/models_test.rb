...
class ActiveRecordTest < ActiveSupport::TestCase
  ...
  test 'order of module inclusion' do
    correct_module_order   = %i[database_authenticatable recoverable registerable confirmable lockable
                                timeoutable]
    incorrect_module_order = %i[database_authenticatable timeoutable registerable recoverable lockable
                                confirmable]
...
class CheckFieldsTest < ActiveSupport::TestCase
  ...
  test 'raises Devise::Models::MissingAtrribute and shows the missing attribute if the class doesn\'t respond_to one of the attributes' do
    ...
    assert_raise_with_message Devise::Models::MissingAttribute,
                              'The following attribute(s) is (are) missing on your model: email' do
  ...
  test 'raises Devise::Models::MissingAtrribute with all the missing attributes if there is more than one' do
    ...
    assert_raise_with_message Devise::Models::MissingAttribute,
                              'The following attribute(s) is (are) missing on your model: encrypted_password, email' do
